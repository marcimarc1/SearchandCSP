...
public class WeightedSum extends ASTNode {
    ...
    public void toMinionLeq(StringBuilder b, ASTNode aux) {
    ...
    public void toMinionGeq(StringBuilder b, ASTNode aux) {
        boolean all1weights = true;
        for (int i =0; i < weights.length; i++) {
            if (weights[i] != 1) {
                all1weights = false;
    ...
    // Flatzinc ones.
    public void toFlatzincLeq(StringBuilder b, ASTNode aux) {
    ...
    public void toFlatzincGeq(StringBuilder b, ASTNode aux) {
        b.append("constraint int_lin_le([");
        for (int i =0; i < weights.length; i++) { b.append(-weights[i]); b.append(","); }
        b.append("1],[");
        for (int i =0; i < numChildren(); i++) { getChild(i).toFlatzinc(b, false); b.append(","); }
