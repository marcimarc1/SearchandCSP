        ...
        try {
            ...
            if(statssofar!=null) {
                ...
                if(idx!=-1) {
                    ...
                    int tlimit2=tlimit-((int)Math.floor(Double.valueOf(statssofar.getValue("SolverTotalTime"))))+30;  // Add some seconds for safety.
                    if(tlimit2>tlimit) tlimit2=tlimit;     //  Don't let the calculated time limit get larger than the original. 
